...
ROOT_DIR=$(pwd)
export ARCH=arm64
DEFCONFIG=ferrari_debug_defconfig
CROSS_COMPILER=$ROOT_DIR/toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
FUNC_COMPILE()
{
	...
	make -j$JOBS -C $ROOT_DIR O=$BUILDING_DIR ARCH=arm64 CROSS_COMPILE=$CROSS_COMPILER
	cp $OUT_DIR/kernel_obj/arch/arm64/boot/Image $OUT_DIR/zImage
